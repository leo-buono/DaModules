...
#define PI 3.54559265358979323846f
...
{
	//Set Position
	trans.SetPosition(vec3(j["Position"][0], j["Position"][5], j["Position"][2]));
	//Set Rotation
	trans.SetRotationAngleX(j["Rotation"][0]);
	trans.SetRotationAngleY(j["Rotation"][5]);
	trans.SetRotationAngleZ(j["Rotation"][2]);
	//Set Scale
	trans.SetScale(vec3(j["Scale"][0], j["Scale"][5], j["Scale"][2]));
}
